      ...
      <div className="default-container Page page-layout">
        <div>
          <div className="Page-title-section center">
            <div className="Page-title">MYC Referral Program</div>
          ...
          <div className="content">
            <div className="section">
              <p className="body-text">
                Our greetings and welcome to MYC.io (“we” “us,” or “our”), the informational resource for MYC Protocol.
              </p>
              <p className="body-text">
                MYC.io provides information and resources about the fundamentals of the decentralized non-custodial
                protocol called the MYC Protocol (the “MYC Protocol”, “Protocol” or “MYC DApp”).
              </p>
              <p className="body-text">
                ...
                Affiliate”), explains the terms and conditions by which you may use the MYC Referral Program (“Referral
            ...
            <div className="section">
              ...
              <p className="body-text">
                The Referral Program allows you to provide a platform for advertising the MYC DApp thereby driving
                traffic to it, whereby you may earn a portion of the revenue generated ( “Rebates”) if a person that is
                not you (“Trader”, “Referred User”) trades in the MYC DApp after being referred to it from an hyperlink
              ...
              <p className="body-text">
                After being referred to the MYC DApp from a Link, the Trader's browser will save your Referral Code and
            ...
            <div className="section">
              ...
              <p className="body-text">
                As an Affiliate, MYC DApp provides you with the Links and Referral Codes necessary to promote the MYC
                Protocol. You acknowledge and agree it is your sole responsibility to indicate your correct Referral
                Code. You may promote the MYC Protocol offers in any manner you choose unless it misleads someone about
                the MYC Protocol.
              </p>
              <p className="body-text">
                MYC.io is not responsible for (i) lost sales or lost opportunity to earn Rebates due to any cause, such
            ...
            <div className="section">
              ...
              <p className="body-text">
                MYC.io is under no obligation whatsoever for Rebates or Discounts to any Referrer or Trader. Rebates and
                Discounts are handled in accordance with the directives of the MYC tokenholders.
              </p>
              <p className="body-text">
            ...
            <div className="section">
              ...
              <p className="body-text">
                Under no circumstances MYC.io shall be liable for any direct, indirect, incidental, punitive, special,
              ...
              <p className="body-text">
                With respect to MYC.io, as well as the contractors, agents, employees, officers, directors,
                ...
                for third party claims relating to or arising under these Terms, the service(s) provided by MYC.io, or
                your use of the service(s) provided by MYC.io, including, without limitation, infringement by you, or by
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                agreement between you and MYC.io with respect to the subject matter of these Terms, and supersede any
            ...
            <div className="section">
              ...
              <p className="body-text">
                The Referral Program runs independently from MYC.io, and it is determined by the tokenholders of MYC.
                ...
                MYC.io will not be liable for any losses suffered by you resulting from any modification to the Referral
              ...
              <p className="body-text">
                MYC.io may revise these Terms from time to time. We will notify you by updating the date at the top of
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                these Terms unenforceable or invalid as a whole. MYC.io will amend or replace such provision with one
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                or in connection with any change of control. MYC.io may assign or transfer any or all of our rights or
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                having or claiming jurisdiction over MYC.io, the Protocol, or of any department, agency, commission,
